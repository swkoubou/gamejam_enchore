(function (global) {
    var GachaScene = Class.create(Scene, {
        initialize: function (status, girls) {
            ...
            gachaMachine.image = game.assets[PATH.GACHA.FIRST];
            gachaMachine.x = 210;
            gachaMachine.y = 210;
            ...
            gachaMachineButton.image = game.assets[PATH.GACHA.HEART];
            ...
            // ガチャマシーン実行ボタンイベント
            gachaMachineButton.addEventListener('touchend', this.onGachaTouched.bind(this));
        ...
        onGachaTouched: function () {
            this.allRemoveChild();
            this.addChild(this.gachaMachine);
            this.addChild(this.gachaMachineButton);

            this.gachaMachine.tl.delay(10).rotateBy(360, 20);
            this.gachaMachineButton.tl.scaleTo(0, 30).and().fadeOut(10).then(this.onGachaResult.bind(this));
        },

        onGachaResult: function () {
            this.allRemoveChild();
